...
From raven Require Import verification.expressions verification.assertions verification.ir verification.procedures.
...
(** The semantic model, as a term.  Unlike a Rocq module argument, a value
    of this record may depend on ghost names allocated inside an Iris
    adequacy proof. *)
